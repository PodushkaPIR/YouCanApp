...
fun MainScreen(navController: NavHostController){
    Scaffold(
        ...
        Column(){
            NoteItem(title = "1", subtitle = "1", navController = navController)
            NoteItem(title = "2", subtitle = "2", navController = navController)
            NoteItem(title = "3", subtitle = "3", navController = navController)
            NoteItem(title = "4", subtitle = "4", navController = navController)
        }
    }
}
